...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        RunTest_pushButton->setGeometry(QRect(980, 120, 89, 30));
        ...
        ChosenPerfGroups_List->setGeometry(QRect(578, 21, 461, 301));
        AddPerfGroup_pushButton = new QPushButton(PerfGroup_Tab);
        AddPerfGroup_pushButton->setObjectName(QStringLiteral("AddPerfGroup_pushButton"));
        AddPerfGroup_pushButton->setGeometry(QRect(450, 110, 110, 30));
        RemovePerfGroup_pushButton = new QPushButton(PerfGroup_Tab);
